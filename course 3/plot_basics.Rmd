---
title: "R language and data analysis:plot basics"
author: "Qiang Shen"
date: "Oct.8,2016"
header-includes:
  - \usepackage{ctex}
...
lapply(type,function(m) plot(x,y,type=m,main=paste0("Plot type:\"",m,"\"")))
```
...
y=c(1:5,5:1)
ltype=1:6
lapply(ltype,function(m) plot(x,y,type='l',lty=m,main=paste0("Line type:\"",m,"\"")))
```
