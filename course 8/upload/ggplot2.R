...
## ------------------------------------------------------------------------
library(sm);data(Salaries, package="car")
...
## ----fig.height=4--------------------------------------------------------
a<-ggplot(Salaries,aes(x=rank,fill=sex))+geom_bar()
b<-ggplot(Salaries,aes(x=rank))+ geom_bar(fill="cornflowerblue")
c<-ggplot(Salaries,aes(x=rank,fill="cornflowerblue"))+
geom_bar()
library(gridExtra);grid.arrange(a,b,c,ncol=3)
