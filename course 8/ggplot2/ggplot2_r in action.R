...
# hist(mtcars$mpg,breaks = 29,col = 'gray')
...
#                color="black", notch=T)+
#   geom_point(position="jitter", color="blue", alpha=.8)+
...
ggplot(Salaries, aes(x=yrs.since.phd, y=salary,  shape=sex,
...
##stack by default.
ggplot(Salaries, aes(x=rank)) + geom_bar(fill="cornflowerblue")

ggplot(Salaries, aes(x=rank, fill="cornflowerblue")) + geom_bar()
